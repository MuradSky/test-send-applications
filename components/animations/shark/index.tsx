  ...
  return (
    <div ref={rootRef} className={clsx(s.shark, customClass)} data-selector="parallax.item">
      ...
      <svg viewBox="0 0 208 63" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M145.718 62.0001H207.307V0.876904C207.103 0.876904 206.907 0.862305 206.703 0.862305C173.119 0.862305 145.885 28.2082 145.718 62.0001Z" stroke="#E40F95" strokeWidth="0.71" strokeMiterlimit="10"/>
        <path d="M73.3623 62.0001H134.952V0.876904C134.748 0.876904 134.552 0.862305 134.348 0.862305C100.764 0.862305 73.5296 28.2082 73.3623 62.0001Z" stroke="#E40F95" strokeWidth="0.71" strokeMiterlimit="10"/>
        <path d="M1 62.0001H62.5893V0.876904C62.3857 0.876904 62.1893 0.862305 61.9856 0.862305C28.4013 0.862305 1.16003 28.2082 1 62.0001Z" stroke="#E40F95" strokeWidth="0.71" strokeMiterlimit="10"/>
      </svg>
    </div>
  )
};
